...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\CycleType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\CycleType']) ? $this->services['AppBundle\Form\CycleType'] : ($this->services['AppBundle\Form\CycleType'] = new \AppBundle\Form\CycleType())) && false ?: '_'};
}, 'AppBundle\\Form\\TenantType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\TenantType']) ? $this->services['AppBundle\Form\TenantType'] : ($this->services['AppBundle\Form\TenantType'] = new \AppBundle\Form\TenantType())) && false ?: '_'};
